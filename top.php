	 <div class="header-top">
		 <!--container-->
		  <div class="container">
			 <div class="top-nav">
						<div class="logo">
						<a href="#"><img src="images/lg1.jpg" id="section-1" class="img-responsive" alt=""/></a>
						</div>
						<div class="menu">
						<ul id="nav">
                        ...
                        <li><a href="category.php" onclick="javascript:window.open('category.php','_self')">View Packages</a></li>
